...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (focusTimeTracker && focusTimeTracker.initialized) {
    ...
    const deepFocusMessages = [
      ...
      // New comprehensive validation and diagnostic handlers
      'VALIDATE_DEEP_FOCUS_DATA', 'BACKUP_DEEP_FOCUS_DATA', 'RESTORE_DEEP_FOCUS_DATA',
      'SYNC_DEEP_FOCUS_STATUS', 'RESET_DEEP_FOCUS_STORAGE', 'GET_DEEP_FOCUS_DIAGNOSTICS',
      // SURGICAL FIXES: Add missing ExtensionDataService message types
      'GET_DEEP_FOCUS_SESSIONS_DATE_RANGE', 'GET_TODAY_DEEP_FOCUS_SESSIONS',
      'GET_ACTIVE_DEEP_FOCUS_SESSION', 'GET_ALL_DEEP_FOCUS_SESSIONS',
      'GET_RECENT_7_DAYS_DEEP_FOCUS_SESSIONS', 'GET_LAST_10_DEEP_FOCUS_SESSIONS'
    ];
