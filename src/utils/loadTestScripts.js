/**
 * Load Test Scripts for Override Session Testing
 * Paste this into the web app console to load all testing functions
 */

(function() {
    // Test Override Session Creation Script
        ...
        try {
            ...
            for (const session of sessions) {
                try {
                    ...
                    // Try to access the overrideSessionService from window
                    if (window.overrideSessionService?.createOverrideSession) {
                        ...
                        console.warn('⚠️ overrideSessionService.createOverrideSession not available on window');
                        console.log('ℹ️ Available window properties:', Object.keys(window).filter(k => k.includes('override') || k.includes('Override')));
                    }
    ...
    console.log('');
    console.log('🚀 Ready to test! Run: testOverrideSessionFlow()');
})();